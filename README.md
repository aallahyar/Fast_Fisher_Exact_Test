...
Fast implementation of Fisher exact test (hypergeometric test) in Matlab. We can use fisher exact test to calculate the association between two groups. The following is an contingency table for association between being a man (or woman) and wearing hat.
